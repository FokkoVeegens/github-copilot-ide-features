...
If the feature is mentioned in the release notes and in our [features.json](/data/features.json) it's flagged `preview-version`, remove the `preview-version` flag.